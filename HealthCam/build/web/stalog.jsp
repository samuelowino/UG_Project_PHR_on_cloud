...
<div id="navigation-bg">
	...
	<div id="navigation">
		<ul class="mainMenu">
			...
			<li><a href="stalog.jsp"  class="selectMenu">STA</a></li>
...
<div id="ourCompany-bg">
	...
	<tr>
	<td align="center">
	<img src="images/sta-log copy.png" width="200" height="200" />
	</td>
	<td>
	<table align="center" width="400" style="border:1px solid green;" bgcolor="#FFFFFF">
		<form name="f" action="stalog1.jsp" method="post" onSubmit="return valid();">
		<tr>
		<td height="36" colspan="2" align="center" bgcolor="#FF9900" class="paragraping">Trusted Authority  Login Here</td>
		</tr>
		<tr>
