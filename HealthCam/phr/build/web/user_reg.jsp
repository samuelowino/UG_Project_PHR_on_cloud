...
<div id="navigation-bg">
	...
	<div id="navigation">
		<ul class="mainMenu">
			<li><a href="camhome.jsp" title="Home">Home</a></li>
...
<div id="ourCompany-bg">
	...
	<table align="center" width="506" style="border:1px solid green;" bgcolor="#FFFFFF">
		<form name="f" action="user_reg1.jsp" method="post" onSubmit="return valid();">
		<tr>
...
<td class="paragraping" colspan="2" align="center"><font size="2"><b><%
		...
		<td height="41" class="paragraping">Gender:</td>
                <td><select name="gen" class="input">
                   ...
                   <!--<input type="text" name="gen" value="" class="input"></td>-->
		</tr>
		<tr>
		...
		<td><input type="text" name="date" value="<%=strDateNew1%>" class="input"></td>
		</tr>
		<tr>
		<td height="40"></td>
