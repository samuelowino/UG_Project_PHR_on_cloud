...
psmt1=con.prepareStatement("select tok_id,AES_DECRYPT(uid,'key'),AES_DECRYPT(name,'key'),AES_DECRYPT(query,'key'),AES_DECRYPT(qdate,'key') from token where AES_DECRYPT(token,'key')='"+s+"'");
