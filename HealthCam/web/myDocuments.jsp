...
<div id="ourCompany-bg">
 ...
 <tr bgcolor="orange">
	 <td class="paragraping2">Upload Date</td><td class="paragraping2">Uploaded By</td><td class="paragraping2">Files</td>
	 </tr>
...
%>
<tr>
    <td class="paragraping"><%=rs.getString("date_")%></td><td class="paragraping" ><%=rs.getString("byuser")%></td></span></form></td><td class="paragraping"><form  action="download"><span onclick="submitForm('<%=rs.getString("filename")%>')" style="cursor: pointer;"><%=rs.getString("filename")%>
