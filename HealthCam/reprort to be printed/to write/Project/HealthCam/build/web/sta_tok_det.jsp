...
<div id="ourCompany-bg">
    ...
    <tr>
    <td><form>
    &nbsp;&nbsp;<a href="stahome.jsp"><font size="+1" color="green"><input type="image" src="images/forum.jpg" width="25" height="25" >&nbsp;&nbsp; Token Generation</font></a><br><br>
    &nbsp;&nbsp;<a href="sta_tok_det.jsp"><font size="+1" color="red"><input type="image" src="images/icon-more.gif" width="25" height="25" >&nbsp;&nbsp;Token Details</font></a><br><br>
...
psmt1=con.prepareStatement("select tok_id,AES_DECRYPT(uid,'key'),AES_DECRYPT(name,'key'),AES_DECRYPT(token,'key'),AES_DECRYPT(query,'key'),AES_DECRYPT(qdate,'key') from token");
...
<tr>
		...
		<td class="paragraping"><font color="#FF0000"><%=rs.getString(4)%></font></td>
