...
<div id="ourCompany-bg">
   ...
   <td width="650">
    ...
    <tr bgcolor="#454545">
	 ...
	 <td class="paragraping2">Title</td>
	 <td class="paragraping2">Min Value</td>
	  <td class="paragraping2">Max Value</td>
	 <td class="paragraping2">Discription</td>
	 <td class="paragraping2">Related Posts</td>
...
psmt1=con.prepareStatement("select mid,AES_DECRYPT(tid,'key'),AES_DECRYPT(titname,'key'),AES_DECRYPT(minvalue,'key'),AES_DECRYPT(maxvalue,'key'),AES_DECRYPT(disc,'key') from medication");
...
<tr>
		...
		<td class="paragraping"><a href="viewpost.jsp?<%=rs.getString(1)%>">View</a></td>
	  </tr>	
